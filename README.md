...
### Please backup any configurations, huds, maps or sound files if you have any. Remove them prior to using this to prevent conflicts
This configuration is made in mind with average end computers, but not too low. It prioritizes performance over looks.
...
Do not force any compatibility layer - native, usually faster, safer. theres the performance factor \
