...
## A TF2 config to get MOAR speed
...
It prioritizes performance over looks but not too much
...
### WARNING: Backup and move away any unsafe configurations, huds or other mod

files if you have that might conflict
...
Do not force any compatibility layer - native is usually faster, safer. Theres
the performance factor \
in Proton but it gives most players an insecure mode issue because of VAC suspicion.
...
meant to be used with the rest of the configurations
